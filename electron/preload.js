...
contextBridge.exposeInMainWorld('api', {
  ...
  cmaNormalReport:      (year, month)        => ipcRenderer.invoke('cma:getNormalReport', year, month),
  cmaNormalTrsReport:   (year, month)        => ipcRenderer.invoke('cma:getNormalTrsReport', year, month),
  cmaFrpReport:         (year, month)        => ipcRenderer.invoke('cma:getFrpReport', year, month),
  cmaExportNormalExcel: (year, month, agent) => ipcRenderer.invoke('cma:exportNormalExcel', { year, month, agent }),
  cmaExportFrpExcel:    (year, month, agent) => ipcRenderer.invoke('cma:exportFrpExcel', { year, month, agent }),
